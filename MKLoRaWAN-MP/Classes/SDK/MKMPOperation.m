...
/**
 线程ID
 */
@property (nonatomic, assign)mk_mp_taskOperationID operationID;
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKMPTaskAdopter parseReadDataWithCharacteristic:characteristic]];
}

- (void)peripheral:(CBPeripheral *)peripheral didWriteValueForCharacteristic:(CBCharacteristic *)characteristic {
    [self dataParserReceivedData:[MKMPTaskAdopter parseWriteDataWithCharacteristic:characteristic]];
}
...
- (void)dataParserReceivedData:(NSDictionary *)dataDic{
    ...
    mk_mp_taskOperationID operationID = [dataDic[@"operationID"] integerValue];
    if (operationID == mk_mp_defaultTaskOperationID || operationID != self.operationID) {
        return;
    }
