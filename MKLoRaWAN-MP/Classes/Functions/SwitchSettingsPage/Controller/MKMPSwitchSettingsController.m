//
//  MKMPSwitchSettingsController.m
...
@interface MKMPSwitchSettingsController ()<UITableViewDelegate,
...
@property (nonatomic, strong)MKMPSwitchSettingsModel *dataModel;

@end

@implementation MKMPSwitchSettingsController

- (void)dealloc {
    NSLog(@"MKMPSwitchSettingsController销毁");
}
...
- (void)loadSection1Datas {
    ...
    cellModel1.textPlaceholder = @"10 - 600";
    cellModel1.textFieldType = mk_realNumberOnly;
    cellModel1.unit = @"S";
    cellModel1.noteMsg = @"*The report interval of switch payloads.";
...
- (MKMPSwitchSettingsModel *)dataModel {
    if (!_dataModel) {
        _dataModel = [[MKMPSwitchSettingsModel alloc] init];
    }
    return _dataModel;
}
