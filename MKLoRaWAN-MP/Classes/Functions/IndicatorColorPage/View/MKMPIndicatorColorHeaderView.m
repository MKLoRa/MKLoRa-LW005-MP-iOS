//
//  MKMPIndicatorColorHeaderView.m
...
@interface MKMPIndicatorColorHeaderViewModel : NSObject
...
@implementation MKMPIndicatorColorHeaderViewModel
@end

@interface MKMPIndicatorColorHeaderView ()<UIPickerViewDataSource, UIPickerViewDelegate>
...
@implementation MKMPIndicatorColorHeaderView
...
- (UIView *)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(nullable UIView *)view{
    ...
    MKMPIndicatorColorHeaderViewModel *model = self.dataList[row];
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component{
    ...
    if ([self.delegate respondsToSelector:@selector(mp_colorSettingPickViewTypeChanged:)]) {
        [self.delegate mp_colorSettingPickViewTypeChanged:model.colorType];
    }
}
...
- (void)updateColorType:(NSInteger)colorType {
    ...
    for (NSInteger i = 0; i < self.dataList.count; i ++) {
        MKMPIndicatorColorHeaderViewModel *model = self.dataList[i];
...
- (void)loadPickViewDatas {
    MKMPIndicatorColorHeaderViewModel *transitionDirectlyModel = [[MKMPIndicatorColorHeaderViewModel alloc] init];
    ...
    MKMPIndicatorColorHeaderViewModel *transitionSmoothlyModel = [[MKMPIndicatorColorHeaderViewModel alloc] init];
    ...
    MKMPIndicatorColorHeaderViewModel *whiteModel = [[MKMPIndicatorColorHeaderViewModel alloc] init];
    whiteModel.colorMsg = @"White";
    whiteModel.colorType = 2;
    [self.dataList addObject:whiteModel];
    
    MKMPIndicatorColorHeaderViewModel *redModel = [[MKMPIndicatorColorHeaderViewModel alloc] init];
    redModel.colorMsg = @"Red";
    redModel.colorType = 3;
    [self.dataList addObject:redModel];
    
    MKMPIndicatorColorHeaderViewModel *greenModel = [[MKMPIndicatorColorHeaderViewModel alloc] init];
    greenModel.colorMsg = @"Green";
    greenModel.colorType = 4;
    [self.dataList addObject:greenModel];
    
    MKMPIndicatorColorHeaderViewModel *blueModel = [[MKMPIndicatorColorHeaderViewModel alloc] init];
    blueModel.colorMsg = @"Blue";
    blueModel.colorType = 5;
    [self.dataList addObject:blueModel];
    
    MKMPIndicatorColorHeaderViewModel *orangeModel = [[MKMPIndicatorColorHeaderViewModel alloc] init];
    orangeModel.colorMsg = @"Orange";
    orangeModel.colorType = 6;
    [self.dataList addObject:orangeModel];
    
    MKMPIndicatorColorHeaderViewModel *cyanModel = [[MKMPIndicatorColorHeaderViewModel alloc] init];
    cyanModel.colorMsg = @"Cyan";
    cyanModel.colorType = 7;
    [self.dataList addObject:cyanModel];
    
    MKMPIndicatorColorHeaderViewModel *purpleModel = [[MKMPIndicatorColorHeaderViewModel alloc] init];
