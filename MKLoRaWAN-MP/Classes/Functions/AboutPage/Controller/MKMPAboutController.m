...
@implementation MKMPAboutController

- (void)dealloc {
    NSLog(@"MKMPAboutController销毁");
}
...
- (UIImageView *)aboutIcon{
    if (!_aboutIcon) {
        ...
        _aboutIcon.image = LOADICON(@"MKLoRaWAN-MP", @"MKMPAboutController", @"mp_aboutIcon.png");
    }
    return _aboutIcon;
}
...
- (UIImageView *)bottomIcon {
    if (!_bottomIcon) {
        ...
        _bottomIcon.image = LOADICON(@"MKLoRaWAN-MP", @"MKMPAboutController", @"mp_aboutBottomIcon.png");
    }
    return _bottomIcon;
}
