...
@interface MKMPDFUModule()<LoggerDelegate, DFUServiceDelegate, DFUProgressDelegate>
...
@implementation MKMPDFUModule

- (void)dealloc{
    NSLog(@"MKMPDFUModule销毁");
}
...
- (void)updateWithFileUrl:(NSString *)url
    ...
    self.dfuController = [initiator startWithTarget:[MKMPCentralManager shared].peripheral];
}
