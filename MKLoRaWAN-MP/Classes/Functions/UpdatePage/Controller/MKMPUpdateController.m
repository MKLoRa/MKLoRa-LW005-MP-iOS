...
@interface MKMPUpdateController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic, strong)MKBaseTableView *tableView;

@property (nonatomic, strong)NSMutableArray *dataList;

@property (nonatomic, strong)MKMPDFUModule *dfuModule;
...
@implementation MKMPUpdateController

- (void)dealloc {
    NSLog(@"MKMPUpdateController销毁");
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_mp_startDfuProcessNotification" object:nil];
...
- (void)updateComplete {
    ...
    [MKMPCentralManager sharedDealloc];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"mk_mp_centralDeallocNotification" object:nil];
...
- (MKMPDFUModule *)dfuModule {
    if (!_dfuModule) {
        _dfuModule = [[MKMPDFUModule alloc] init];
    }
    return _dfuModule;
}
