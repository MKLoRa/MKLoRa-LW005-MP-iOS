...
@interface MKMPLoRaSettingConfigModel : NSObject
...
@interface MKMPLoRaSettingModel : NSObject

@property (nonatomic, strong, readonly)MKMPLoRaSettingConfigModel *configModel;
