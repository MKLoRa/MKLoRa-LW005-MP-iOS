...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    ...
    if (section == 10) {
        ...
        return ((self.dataModel.messageType == 0) ? 0 : self.optionsList7.count);
    }
    return 0;
}
...
- (void)mk_loraTextButtonCellSelected:(NSInteger)index
    ...
    if (index == 2) {
        ...
        MKTextButtonCellModel *classModel = self.section2List[1];
    ...
    if (index == 3) {
        ...
        MKTextButtonCellModel *messageModel = self.section2List[2];
    ...
    if (index == 5) {
        ...
        MKTextButtonCellModel *drModel = self.optionsList7[0];
...
- (void)mk_loraSetting_advanceCell_switchStatusChanged:(BOOL)isOn {
    ...
    NSInteger sections = (self.dataModel.advancedStatus ? 11 : 4);
...
- (void)regionValueChanged {
    ...
    adrModel.isOn = self.dataModel.adrIsOn;
    //DR For Payload
    MKLoRaSettingCHCellModel *drModel = self.optionsList6[0];
    ...
    //Max retransmission times
    MKTextButtonCellModel *trModel = self.optionsList7[0];
...
- (void)loadOptionsList7 {
    ...
    [self.optionsList7 addObject:retransmissionModel];
}
