...
static MKMPUserLoginManager *loginManager = nil;
static dispatch_once_t onceToken;

@interface MKMPUserLoginManager ()
...
+ (MKMPUserLoginManager *)shared {
    dispatch_once(&onceToken, ^{
        if (!loginManager) {
            loginManager = [MKMPUserLoginManager new];
        }
    });
    return loginManager;
}
