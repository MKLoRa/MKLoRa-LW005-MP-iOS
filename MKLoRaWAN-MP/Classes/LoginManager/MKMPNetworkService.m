...
@implementation MKMPCreateLoRaDeviceModel
...
- (NSDictionary *)params {
    ...
    NSString *model = @"40";
    NSString *applicationIdFull = @"LW005_MP";
    NSString *profilesType = @"005_MP";
...
@interface MKMPNetworkService ()

@property (nonatomic, strong)NSURLSessionDataTask *addLoRaDeviceTask;

@end

@implementation MKMPNetworkService

+ (instancetype)share {
    static dispatch_once_t t;
    static MKMPNetworkService *service = nil;
    dispatch_once(&t, ^{
        service = [[MKMPNetworkService alloc] init];
    });
    return service;
}

- (void)addLoRaDeviceToCloud:(MKMPCreateLoRaDeviceModel *)deviceModel
